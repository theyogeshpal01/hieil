  ...
  { 
    ...
    columns: {
      ...
      headers: [
        ...
        { key: 'tag', label: 'Tag', formLabel: 'Tag Name (Optional)', placeholder: 'Enter Product Tag' },
        { key: 'highlight', label: 'Highlight', formLabel: 'Product Highlight (Optional)', placeholder: 'Enter Highlight (e.g. Bestseller)' },
        { key: 'sizes', label: 'Sizes', formLabel: 'Size (Optional)', placeholder: 'Enter size (e.g. 21 x 11.5 x 5 cm)' },
        { key: 'materials', label: 'Materials', formLabel: 'Materials (Optional)', placeholder: 'Enter materials (e.g. quartz stone powder)' },
        { key: 'colors', label: 'Colors', formLabel: 'Color options (Optional)', placeholder: 'Select colors will appear here' },
        { key: 'hsnCode', label: 'HSN Code', formLabel: 'HSN Code (Optional)', placeholder: 'Enter HSN Code' },
        { key: 'productCode', label: 'Product Code', formLabel: 'Product Code (Optional)', placeholder: 'Enter Product Code' },
        { key: 'price', label: 'Price', formLabel: 'Product Price (Optional)', placeholder: 'Enter Product Price' },
        { key: 'offerPrice', label: 'Offer Price', formLabel: 'Offer Price (Optional)', placeholder: 'Enter Offer Price' },
        ...
        { key: 'craftHighlight', label: 'Highlight / Craft', type: 'rich-text', formLabel: 'Highlight / Craft (Optional)' },
        ...
        { key: 'addImg1', label: 'Add Img 1', type: 'file', formLabel: 'Additional Image 1 (Optional)', hideInTable: true },
        { key: 'addImg2', label: 'Add Img 2', type: 'file', formLabel: 'Additional Image 2 (Optional)', hideInTable: true },
        { key: 'addImg3', label: 'Add Img 3', type: 'file', formLabel: 'Additional Image 3 (Optional)', hideInTable: true },
        { key: 'addImg4', label: 'Add Img 4', type: 'file', formLabel: 'Additional Image 4 (Optional)', hideInTable: true },
        { key: 'addImg5', label: 'Add Img 5', type: 'file', formLabel: 'Additional Image 5 (Optional)', hideInTable: true },
        { key: 'aboutProduct', label: 'About Product', hideInForm: true },
        { key: 'description', label: 'Description', type: 'rich-text', formLabel: 'Product Description (Optional)', minWidth: '400px' },
        { key: 'craftsmanship', label: 'Craftsmanship', type: 'rich-text', formLabel: 'Craftsmanship & Care (Optional)' },
        { key: 'shipping', label: 'Shipping', type: 'rich-text', formLabel: 'Shipping & Returns (Optional)' },
      ]
    },
    data: []
  },
