    ...
    <div className="min-h-screen bg-[#1C1713]">
      ...
      <section className="relative bg-[#1C1713] text-white py-16 md:py-24 px-6 md:px-12 lg:px-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-block px-4 py-2 bg-white/10 text-orange-400 rounded-none text-sm font-semibold tracking-wider mb-6">
              HIEIL CRAFTSMANSHIP
            </div>
            <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6 font-serif">
              A Few Words <br />
              <span className="text-[#c2a373]">About Us</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="px-8 py-4 bg-[#c2a373] hover:bg-[#917751] text-white rounded-none font-semibold transition-all duration-300 shadow-none  flex items-center gap-2">
          ...
          <div className="hidden md:flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-none border-4 border-[#c2a373]/30 flex items-center justify-center p-4 relative z-10 bg-[url('/aboutus.png')] bg-cover bg-center overflow-hidden shadow-none">
                <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px]"></div>
                <div className="text-center relative z-20">
                  <span className="block text-6xl font-bold text-[#c2a373] mb-2">7+</span>
                  <span className="block text-xl font-medium tracking-wide uppercase text-white">Years of<br/>Excellence</span>
                </div>
              </div>
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[#c2a373]/10 rounded-none animate-pulse blur-3xl"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 bg-[#15110F] border-y border-[#2c241c]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="px-6 py-3 bg-[#1C1713] text-white border border-[#2c241c] hover:border-[#c2a373] hover:text-[#c2a373] rounded-none font-medium transition-colors flex items-center gap-2 shadow-none">
              <Globe size={18} /> View Online
            </button>
            <button className="px-6 py-3 bg-[#c2a373] hover:bg-[#917751] text-white rounded-none font-medium transition-colors flex items-center gap-2 shadow-none">
      ...
      <section className="py-20 px-6 md:px-12 bg-[#15110F]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-4">Who We Are</h2>
      ...
      <section className="py-16 bg-[#1C1713] text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center mb-12">
          <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">Our Impact</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="text-center p-6 rounded-none bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
              <stat.icon className="w-10 h-10 text-[#c2a373] mx-auto mb-4 opacity-80" />
      ...
      <section className="py-20 px-6 md:px-12 bg-[#1C1713]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">Our Leaders</h2>
            ...
            <div className="bg-[#15110F] rounded-none p-8 md:p-10 shadow-none hover:shadow-none transition-all duration-300 border border-[#2c241c] relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-5 mb-6">
                  <div className="w-20 h-20 bg-[#c2a373]/20 rounded-none flex items-center justify-center text-[#c2a373] text-2xl font-bold">
                    JS
                  </div>
                  <div>
                    <h4 className="text-2xl font-bold text-white">Jogendra Singh</h4>
                    <p className="text-[#c2a373] font-medium text-sm">Founder & Director</p>
                  </div>
                </div>
                ...
                <ul className="flex flex-wrap gap-2">
                  {['Visionary Leader', 'Artisan Advocate', 'Global Strategist'].map((tag, i) => (
                    <li key={i} className="px-3 py-1.5 bg-[#1C1713] rounded-none text-sm font-medium text-[#b5aaa0] flex items-center gap-2 border border-[#2c241c]">
                      <CheckCircle2 size={14} className="text-[#c2a373]" /> {tag}
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-5 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[#c2a373] font-medium text-sm">Chief Executive Officer</p>
                  </div>
                </div>
                <div className="space-y-4 text-[#b5aaa0] leading-relaxed mb-8">
      ...
      <section className="py-20 px-6 md:px-12 bg-[#15110F]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">Our Journey</h2>
            <h3 className="text-3xl md:text-5xl font-serif font-bold text-white">7+ Years of Excellence</h3>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="relative p-6 border border-[#2c241c] rounded-none bg-[#1C1713] hover:bg-[#15110F] hover:shadow-none transition-all duration-300 group">
                <div className="text-4xl font-bold text-[#c2a373]/20 mb-4 group-hover:text-[#c2a373]/30 transition-colors">0{step.num}</div>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#1C1713] text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">Our Values</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="group">
                <div className="w-12 h-12 bg-white/10 rounded-none flex items-center justify-center mb-4 group-hover:bg-[#c2a373] transition-colors duration-300">
                  <value.icon className="text-[#c2a373] group-hover:text-white transition-colors" size={24} />
                </div>
      ...
      <section className="py-16 px-6 md:px-12 bg-[#15110F]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="px-8 py-4 bg-[#c2a373] hover:bg-[#917751] text-white rounded-none font-semibold transition-all duration-300 shadow-none hover:shadow-none hover:-translate-y-1">
            Contact Us Today
          </button>
        </div>
      </section>
