    ...
    <div className="min-h-screen bg-[#1C1713]">
      ...
      <section className="relative bg-[#1C1713] text-white py-20 md:py-32 px-6 md:px-12 lg:px-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="inline-block px-4 py-2 bg-[#15110F]/20 text-orange-400 rounded-none text-sm font-semibold tracking-wider mb-6">
            WHY CHOOSE US
          </div>
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6 font-serif">
            More Than Just Exporters — <br />
            <span className="text-[#c2a373]">Partners in Your Success</span>
          </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto border-t border-white/10 pt-10">
            <div className="text-center">
              <div className="text-3xl font-bold text-[#c2a373] mb-1">100%</div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-[#c2a373] mb-1">50+</div>
              <div className="text-sm text-[#b5aaa0] font-medium">Global Markets</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#c2a373] mb-1">24/7</div>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#15110F]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">Global Standards, Local Craft</h2>
            <h3 className="text-3xl md:text-4xl font-serif font-bold text-white mb-6">Where Tradition Meets Excellence</h3>
            ...
            <div className="space-y-6 mt-8">
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 bg-[#15110F] rounded-none flex items-center justify-center shrink-0">
                  <Star className="text-[#c2a373]" size={24} />
                </div>
                <div>
              ...
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 bg-[#15110F] rounded-none flex items-center justify-center shrink-0">
                  <ShieldCheck className="text-[#c2a373]" size={24} />
                </div>
                <div>
              ...
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 bg-[#15110F] rounded-none flex items-center justify-center shrink-0">
                  <FileText className="text-[#c2a373]" size={24} />
                </div>
                <div>
          ...
          <div className="relative h-full min-h-[400px] rounded-none overflow-hidden shadow-none">
             ...
             <div className="absolute bottom-8 left-8 right-8 text-white">
                <div className="flex items-center gap-3 mb-2">
                  <Award className="text-[#c2a373]" size={32} />
      ...
      <section className="py-20 px-6 md:px-12 bg-[#1C1713] border-y border-[#1C1713]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">Our Trust Factors</h2>
            <h3 className="text-3xl md:text-4xl font-serif font-bold text-white">Why Businesses Worldwide Trust Us</h3>
          </div>
            ...
            {[
              ...
              <div key={i} className="bg-[#15110F] p-8 rounded-none shadow-none border border-[#1C1713] hover:shadow-none transition-all duration-300 group">
                <div className="w-14 h-14 bg-[#15110F] rounded-none flex items-center justify-center mb-6 group-hover:bg-[#15110F] transition-colors duration-300">
                  <feature.icon className="text-[#c2a373] group-hover:text-white transition-colors" size={28} />
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-12 justify-between items-end mb-16 border-b border-white/10 pb-8">
            <div className="max-w-2xl">
              <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">End-to-end Export Solutions</h2>
          ...
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-16">
            {[
              ...
              <div key={i} className="flex gap-6 items-start group">
                <div className="w-16 h-16 bg-[#15110F]/5 border border-white/10 rounded-none flex items-center justify-center shrink-0 group-hover:bg-[#15110F]/20 group-hover:border-[#c2a373]/50 transition-all duration-300">
                  <sol.icon className="text-[#c2a373]" size={32} />
                </div>
                <div>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#15110F]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20">
          {/* Global Presence */}
          <div>
            <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">By International Buyers</h2>
            <h3 className="text-3xl font-serif font-bold text-white mb-8">Growing Global Presence Across Continents</h3>
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4 items-start p-4 rounded-none hover:bg-[#1C1713] transition-colors border border-transparent hover:border-[#1C1713]">
                  <MapPin className="text-[#c2a373] shrink-0 mt-1" size={24} />
                  <div>
          ...
          {/* Valued Clients */}
          <div>
            <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">Our Valued Clients</h2>
            <h3 className="text-3xl font-serif font-bold text-white mb-8">Trusted by Industry Leaders Worldwide</h3>
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="bg-[#1C1713] p-6 rounded-none border border-[#1C1713]">
                  <Building className="text-[#c2a373] mb-4" size={32} />
      ...
      <section className="py-20 px-6 md:px-12 bg-[#1C1713] border-t border-[#1C1713]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">Your Success Partner</h2>
            <h3 className="text-3xl md:text-4xl font-serif font-bold text-white">Why Choose Us as Your Export Partner</h3>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-[#15110F] p-6 rounded-none border border-[#2c241c] shadow-none flex gap-4 items-start">
                <CheckCircle2 className="text-[#c2a373] shrink-0 mt-1" size={24} />
                <div>
                  <h4 className="text-lg font-bold text-white mb-2">{prop.title}</h4>
                  <p className="text-[#b5aaa0] text-sm leading-relaxed">{prop.desc}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="mt-12 bg-[#15110F] rounded-none p-8 border border-orange-100 flex flex-col md:flex-row gap-8 items-center shadow-none shadow-[#c2a373]/5 relative overflow-hidden">
             <div className="absolute top-0 right-0 p-8 opacity-5">
               <ShieldCheck size={120} />
             </div>
             <div className="flex-1 relative z-10">
               <h4 className="text-xl font-bold text-white mb-2 flex items-center gap-2">
                 <Star className="text-[#c2a373]" size={20} fill="currentColor" /> 100% Transparency
               </h4>
               <p className="text-[#b5aaa0] mb-6">Complete visibility into development costs, material sourcing, and production timelines.</p>
               
               <h4 className="text-xl font-bold text-white mb-2 flex items-center gap-2">
                 <ShieldCheck className="text-[#c2a373]" size={20} fill="currentColor" /> No Corruption Policy
               </h4>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#1C1713] text-white text-center">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-sm font-bold tracking-widest text-[#c2a373] uppercase mb-3">The Hieil Difference</h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i}>
                <div className="w-12 h-12 bg-[#15110F]/20 text-[#c2a373] rounded-none flex items-center justify-center mx-auto mb-4 border border-[#c2a373]/30">
      ...
      <section className="py-20 px-6 md:px-12 bg-[#15110F]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-6">Ready To Experience Excellence?</h2>
          <p className="text-lg text-[#b5aaa0] mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button className="px-8 py-4 bg-[#15110F] text-white border border-[#2c241c] hover:border-[#c2a373] hover:text-[#917751] rounded-none font-semibold transition-all duration-300 shadow-none flex items-center gap-2">
